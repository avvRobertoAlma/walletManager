...
export const ETNamount = document.querySelector('#ETNamount');
export const ETNinvestment = document.querySelector('#ETNinvestment');
export const XLMamount = document.querySelector('#XLMamount');
export const XLMinvestment = document.querySelector('#XLMinvestment');
